const data = [
  {
    ...
    nickname: "",
    motivation:
      "I must ensure balance in order to bring peace to the realms. I had a vision that my attendance would prevent devastation lasting 100 years. I must make sure 2 other people in attendance never meet each other, but I don’t know who they are.",
    memory: "",
    infamy:
      "Famous and infamous. Generally the public respects me, but I continuously upset a lot of people in my life’s quest to maintain peace.",
    home: "",
    "Email Address": "",
  },
  {
    ...
    motivation:
      "While Kifnali’s motives for attending are different (yet related 😉), I’ve heard rumor that a person I thought long dead is actually very much alive, and may be at this event. This concerns me because they have knowledge of the misdeeds from my past I’ve worked so hard to overcome.",
    memory:
      "The Port city of Essona, where I committed a horrific act that still haunts me. I am determined to make peace with myself, but I am unsure of any loose ends that could potentially unravel all the work I’ve done to forget my past.",
    infamy:
      "Infamous. I bear the name of an infamous pirate captain. Most people that meet me instantly recognize the name and fear me.",
    home:
      "My realm consists of scattered farms and villages with bustling cities. There is mostly peace among the people. While growing up as a simple farmer, I found myself bored with the peace and monotony. And after years of strife and turbulence, those are the qualities I’ve learned to admire most about my realm.",
    "Email Address": "",
  },
  {
  ...
  },
  {
    ...
    nickname: "“The Iron Hammer” leader of the Blacksmiths Guild.",
    motivation:
    ...
    infamy:
      "(Famous) a sublime Craftsman who Built the kings armor but often has to kick you ladies out of the workshop ... because he’s pretty.",
    home:
  ...
  },
  {
    ...
    nickname:
      "The Korruptor — from corrupting my disciples into doing my bidding in my quest for everlasting life.",
